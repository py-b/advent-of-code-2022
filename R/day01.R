...
#' etc. (by "etc", you're pretty sure they just mean "more snacks").
...
#' eventually run out of snacks. To avoid this unacceptable situation, the
#' Elves would instead like to know the total Calories carried by the top
#' three Elves carrying the most Calories. That way, even if one of those
#' Elves runs out of snacks, they still have two backups. In the example
#' above, the top three Elves are the fourth Elf (with `24000` Calories),
